...
var SolusPayCheckout = /** @class */ (function () {
    function SolusPayCheckout(option) {
        var _this = this;
        this.Option = {
        ...
        fetch('https://beta.soluspay.net/api/v1/payment_token/', { method: 'POST' }).then(function (data) { return data.json().then(function (res) { _this.Option.uuid = res.uuid; }); }).catch(function (e) { return console.log(e); });
    }
    SolusPayCheckout.prototype.initPayButton = function () {
    ...
    SolusPayCheckout.prototype.pay = function (amount) {
